...
const Button = class {
  ...
  render() {
    return (index.h("button", { part: 'button', type: this.type, disabled: this.disabled }, index.h("slot", null)));
  }
};
...
const feature$1 = class {
  ...
  render() {
    return (index.h("div", { class: "callout" }, index.h("div", { class: "box a" }, index.h("a", { href: this.ahref }, index.h("h2", null, this.aheading)), index.h("p", null, this.atext), index.h("svg", { "aria-hidden": "true", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", class: "arrow-right" }, index.h("title", null, "arrow-right"), index.h("polygon", { points: "22.71 8.29 21.29 9.71 26.59 15 2 15 2 17 26.59 17 21.29 22.29 22.71 23.71 30.41 16 22.71 8.29" }))), index.h("div", { class: "box b" }, index.h("a", { href: this.ahref }, index.h("h2", null, this.bheading)), index.h("p", null, this.btext), index.h("svg", { "aria-hidden": "true", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", class: "arrow-right" }, index.h("title", null, "arrow-right"), index.h("polygon", { points: "22.71 8.29 21.29 9.71 26.59 15 2 15 2 17 26.59 17 21.29 22.29 22.71 23.71 30.41 16 22.71 8.29" }))), index.h("div", { class: "box c" }, index.h("a", { href: this.ahref }, index.h("h2", null, this.cheading)), index.h("p", null, this.ctext), index.h("svg", { "aria-hidden": "true", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", class: "arrow-right" }, index.h("title", null, "arrow-right"), index.h("polygon", { points: "22.71 8.29 21.29 9.71 26.59 15 2 15 2 17 26.59 17 21.29 22.29 22.71 23.71 30.41 16 22.71 8.29" }))), index.h("div", { class: "box d" }, index.h("a", { href: this.ahref }, index.h("h2", null, this.dheading)), index.h("p", null, this.dtext), index.h("svg", { "aria-hidden": "true", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", class: "arrow-right" }, index.h("title", null, "arrow-right"), index.h("polygon", { points: "22.71 8.29 21.29 9.71 26.59 15 2 15 2 17 26.59 17 21.29 22.29 22.71 23.71 30.41 16 22.71 8.29" })))));
  }
};
...
const Container = class {
  ...
  render() {
    return (index.h("div", { class: "wrapper" }, index.h("div", { class: "container" }, index.h("slot", null))));
  }
};
...
const feature = class {
  ...
  checkHeader(headertext) {
    ...
    if (!this.sectionheader) {
      header = index.h("h2", null, " ", headertext, " ");
    }
    else {
      header = index.h("h3", null, " ", headertext, " ");
    }
    return header;
  }
  ...
  checkSection(header) {
    let section;
    if (this.sectionheader) {
      section = index.h("h2", null, " ", header, " ");
    }
    return section;
  }
  render() {
    return (index.h("div", { class: "feature", "data-type": this.displayType() }, this.checkSection(this.sectionheader), index.h("div", { class: "feature-container" }, this.data.map((data) => index.h("div", { class: "item" }, index.h("div", { class: "image" }, index.h("mc-picture", { photodesktop: data.photodesktop, photomobile: data.photomobile, alt: data.alt, lazy: data.lazy, class: "square" })), index.h("div", { class: "content" }, this.checkHeader(data.header), index.h("p", null, data.intro), index.h("span", { innerHTML: data.links, class: "inline-multi-links" }), index.h("mc-link", { href: data.href, label: data.linktext, class: this.checkButton() })))))));
  }
};
...
const Footer = class {
  ...
  render() {
    return (index.h("footer", null, index.h("mc-link", { label: "Back to top", href: "#", exportparts: "a" }), index.h("p", null, "Nunc efficitur quam leo, ac tincidunt velit lobortis id. Etiam nec mi pellentesque, iaculis arcu et, eleifend nisl. Donec tempus pretium turpis non consequat. Phasellus finibus finibus dolor et tristique. Curabitur elementum, nulla ut facilisis blandit, eros massa varius metus, ut laoreet massa nunc quis lectus."), index.h("p", null, "\u00A9 1998-2020 XYZ Company. All rights reserved.")));
  }
};
...
const Hero = class {
  ...
  render() {
    return (index.h("div", { class: "hero" }, index.h("mc-picture", { photodesktop: this.photodesktop, photomobile: this.photomobile, alt: this.headingtext, lazy: this.lazy, class: "hero" }), index.h("div", { class: "text" }, index.h("h1", null, this.headingtext), index.h("p", null, this.text), index.h("mc-link", { href: this.href, label: this.buttonlabel, class: "button ghost white" }))));
  }
};
Hero.style = heroCss;
...
const Link = class {
  ...
  render() {
    return (index.h("a", { href: this.href, part: "a" }, this.label));
  }
};
Link.style = linkCss;
...
const Masthead = class {
  ...
  render() {
    return (index.h("header", null, index.h("div", { class: 'logo' }, index.h("a", { href: '/' }, index.h("img", { src: index.getAssetPath(`/assets/${this.logo}`), alt: this.imgtitle }))), index.h("nav", null, this.nav.map(nav => (index.h("mc-link", { label: nav.label, href: nav.href, exportparts: 'a' })))), index.h("mc-button", { class: 'plain', exportparts: 'button' }, "Menu")));
  }
...
const Picture = class {
  ...
  render() {
    return (index.h("picture", { part: "picture" }, index.h("source", { srcSet: this.photodesktop, media: "(min-width: 768px)" }), index.h("img", { src: this.photomobile, alt: this.alt, loading: this.lazyLoad() })));
  }
  static get assetsDirs() { return ["./assets"]; }
};
Picture.style = pictureCss;

exports.mc_button = Button;
exports.mc_callout = feature$1;
exports.mc_container = Container;
exports.mc_feature = feature;
exports.mc_footer = Footer;
exports.mc_hero = Hero;
exports.mc_link = Link;
exports.mc_masthead = Masthead;
exports.mc_picture = Picture;
